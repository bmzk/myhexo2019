            ...
            k.fn = k.prototype = {
                ...
                , k.extend = k.fn.extend = function () {
                    ...
                    for ("boolean" == typeof a && (l = a, a = arguments[s] || {
                        ...
                        s < u;
                        s++)if (null != (e = arguments[s])) for (t in e) r = e[t], "__proto__" !== t && a !== r && (l && r && (k.isPlainObject(r) || (i = Array.isArray(r))) ? (n = a[t], o = i && !Array.isArray(n) ? [] : i || k.isPlainObject(n) ? n : {
                        }
                    ...
                    : function (e, t, n) {
                        ...
                        if (c) {
                            ...
                            if (u = [m ? c.firstChild : c.lastChild], m && p) {
                                ...
                                ))[h] || [])[0] === S && r[1]), !1 === d) while (a = ++s && a && a[l] || (d = s = 0) || u.pop()) if ((x ? a.nodeName.toLowerCase() === f : 1 === a.nodeType) && ++d && (p && ((i = (o = a[k] || (a[k] = {
                                }
                                ))[a.uniqueID] || (o[a.uniqueID] = {
                                }
                                    ))[h] = [S, d]), a === e)) break;
    ...
    for (var i, t, n, r = e.length, o = b.relative[e[0].type], a = o || b.relative[" "], s = o ? 1 : 0, u = be(function (e) {
        ...
        s++)if (t = b.relative[e[s].type]) c = [be(we(c), t)];
            ...
            if ((t = b.filter[e[s].type].apply(null, e[s].matches))[k]) {
                for (n = ++s;
                    n < r;
                    n++)if (b.relative[e[n].type]) break;
...
k.fn.extend({
    has: function (e) {
        ...
        return this.filter(function () {
            for (var e = 0;
                e < n;
                e++)if (k.contains(this, t[e])) return !0
        }
        )
    }
    , closest: function (e, t) {
        ...
        if (!N.test(e)) for (;
            ...
            r++)for (n = this[r];
                n && n !== t;
                n = n.parentNode)if (n.nodeType < 11 && (a ? -1 < a.index(n) : 1 === n.nodeType && k.find.matchesSelector(n, e))) {
                    o.push(n);
                    break
                }
...
function we(e, t, n, r, i) {
    for (var o, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length;
        d < h;
        d++)if ((o = e[d]) || 0 === o) if ("object" === w(o)) k.merge(p, o.nodeType ? [o] : o);
        else if (be.test(o)) {
...
k.event = {
    ...
    , handlers: function (e, t) {
        ...
        if (u && l.nodeType && !("click" === e.type && 1 <= e.button)) for (;
            l !== this;
...
function Ie(n, r, i, o) {
    ...
    if (f && (t = (e = we(r, n[0].ownerDocument, !1, n, o)).firstChild, 1 === e.childNodes.length && (e = t), t || o)) {
        ...
        if (s) for (l = a[a.length - 1].ownerDocument, k.map(a, Re), c = 0;
            c < s;
...
function dt(o, e, t) {
    ...
    for (!function (e, t) {
        ...
        r < i;
        r++)if (n = dt.prefilters[r].call(l, o, c, l.opts)) return m(n.stop) && (k._queueHooks(l.elem, l.opts.queue).stop = n.stop.bind(n)), n;
...
k.Animation = k.extend(dt, {
    ...
    , tweener: function (e, t) {
        ...
        for (var n, r = 0, i = e.length;
            r < i;
            r++)n = e[r], dt.tweeners[n] = dt.tweeners[n] || [], dt.tweeners[n].unshift(t)
    }
    ...
    valHooks: {
        ...
        , select: {
            get: function (e) {
                ...
                for (r = o < 0 ? u : a ? o : 0;
                    r < u;
                    r++)if (((n = i[r]).selected || r === o) && !n.disabled && (!n.parentNode.disabled || !A(n.parentNode, "optgroup"))) {
...
Ft.href = Et.href, k.extend({
    ...
    , ajaxSettings: {
        url: Et.href, type: "GET", isLocal: /^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(Et.protocol), global: !0, processData: !0, async: !0, contentType: "application/x-www-form-urlencoded; 
